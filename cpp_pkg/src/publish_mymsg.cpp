#include <chrono>
#include <cpp_pkg/msg/detail/my_sphere_msg__struct.hpp>
#include <functional>
#include <memory>
...
#include "cpp_pkg/msg/my_num_msg.hpp"
#include "cpp_pkg/msg/my_sphere_msg.hpp"
...
public:
  MyMsgPublisherNode() : Node("my_msg_publisher_node") {
    publisher_1_ =
        this->create_publisher<cpp_pkg::msg::MyNumMsg>("my_num_msg_topic", 10);
    publisher_2_ = this->create_publisher<cpp_pkg::msg::MySphereMsg>(
...
private:
  void timer_callback() {
    auto message_1 = cpp_pkg::msg::MyNumMsg();
    auto message_2 = cpp_pkg::msg::MySphereMsg();
    message_1.num = 100;
  ...
  rclcpp::Publisher<cpp_pkg::msg::MyNumMsg>::SharedPtr publisher_1_;
  rclcpp::Publisher<cpp_pkg::msg::MySphereMsg>::SharedPtr publisher_2_;
};
