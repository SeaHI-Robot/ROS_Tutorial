...
#include "action_define/action/fibonacci.hpp"
#include "rclcpp/rclcpp.hpp"
#include "rclcpp_action/rclcpp_action.hpp"
#include "rclcpp_components/register_node_macro.hpp"

#include "action_use/visibility_control.h"

namespace action_use {
class FibonacciActionServer : public rclcpp::Node {
public:
  using Fibonacci = action_define::action::Fibonacci;
...
RCLCPP_COMPONENTS_REGISTER_NODE(action_use::FibonacciActionServer)
